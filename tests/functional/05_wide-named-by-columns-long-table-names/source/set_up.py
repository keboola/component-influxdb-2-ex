...
def run(context: TestDataDir):
    ...
    for i in range(10):
        p = (influxdb_client.Point("field")
             .tag("category-tag-which-is-longer-than-allowed-for-storage-and-needs-to-be-renamed", "a")
             .field("temp", i))
        ...
        p = (influxdb_client.Point("field")
             .tag("other-tag-which-is-longer-than-allowed-for-storage-and-needs-to-be-renamed", "b")
             .field("temp", i))
        write_api.write(bucket="bucket", org="org", record=p)
