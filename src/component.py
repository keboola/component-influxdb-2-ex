...
class Component(ComponentBase):
    ...
    def init_influxdb(self) -> influxdb_client.InfluxDBClient:
        ...
        return influxdb_client.InfluxDBClient(url=source.url, token=source.token, org=source.org)
    ...
    def write_table(self):
        ...
        schema = {{c[0]: ColumnDefinition(data_types=BaseType(dtype=self.convert_dtypes(c[1]))) for c in table_meta}}
